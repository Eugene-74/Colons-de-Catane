...
procedure jouerSonFinDePartie(affichage :TAffichage);


implementation
procedure demarrerSon(affichage : TAffichage;son : TSon);forward;
...
begin
    ...
    Mix_VolumeChunk(pSon, MIX_MAX_VOLUME div 10);
    if Mix_PlayChannel(-1, pSon, 0) = -1 then // premier canal disponible (-1) une seule fois (0)
    begin
...
procedure jouerSonFinDePartie(affichage :TAffichage);
begin
  demarrerSon(affichage,sonFinDePartie);
end;
end.